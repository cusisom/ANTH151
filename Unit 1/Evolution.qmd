...
is to steer you away from thinking that Charles Darwin (discussed below) was the first (or only) person to "discover"
...
(and misrepresentned) by the Christian church which was even later misconstrued by the evolutionary-thinking public. The first of these accounts
...
**Evolution** is less complicated and controversial than often presumed. At its core, it is a process of [change over time]{.underline}. As
mentioned above, this change does not need to be from less complex to more complex, it is just change. For instance, one 
awesome example that flies in the face of linear progression is the evolution of animals such as the Axolotl  [@Voss1997] which underwent a process
...
One of my favorite analogies for evolutionary thinking, instead of relying on the linear progression model, is referred to as the Red Queen Hypothesis. If you are at all familiar with Alice in Wonderland or, even better,
...
Alice by the wrist and begins to run. Minutes go as they sprint through wonderland. Alice is panting and her hair is blowing wildly behind until
...
As instructive as this is, it still does not fully represent Evolution. It is moreso an analogy for Evolution by means of Natural Selection, which we will discuss 
below. The Red Queen is a somewhat imperfect metaphor only because of the emphasis put on a *need* to evolve...the need to keep up with the world around. It includes terms such as **Adaptation** and **Fitness** which
...
non-adaptive evolutionary mechanisms such as <span title="Random changes in allele frequencies within a population from one generation to the next">
**Genetic Drift**</span> and **Migration** that result in evolutionary change without the selection of adaptive traits. The Red Queen reference
...
We will come to see that Darwin was made famous not for his discovery of Evolution by Natural Selection, but for his explanation of how it works. Further, he did so by learning from
the many others who discussed evolution before he did. In fact, all of the early scholars mentioned
in the text play a part in building the foundation for his ultimate monumental monograph. 
...
can subsequently be passed on to the next generation. This is illustrated in the text by the progressive lengthening of giraffe necks. Unfortunatly, it matters very little how much
you change your body during life, your kids are unlikely to inherit the modifications (imagine if you lost your arm in an accident and had a child after...would they be born with one less
arm?). 
...
grow geometrically (growth multiplies by a constant) while resources tend to grow linearlly (adding a fixed amount). Thus, populations
grow faster than resources. Populations, however, cannot grow indefintely in this way. At some point people will outweigh the amount 
...
Discovery of a deep underwater trench that did not provide a land connection between the islands of SE Asia (Sunda) the islands of the Australian landmass (Sahul).
...
here. We will imagine a species of fish that lives in a lake. As might be expected, this species varies in size. Some are pretty big, some are pretty small, but most of the population sits somewhere in the middle.
...
With this population in mind, we can now alter the *selective pressures* to force its evolution through time. Specifically, we are going to change the physical environment and the predator population
