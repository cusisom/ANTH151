...
![](../images/time/dating-fossils.jpg){.lightbox width="50%"}
 
::: {.callout-tip}
## Key Points

- [**Additional Assigned Reading:**]{ .underline } Ch. 7 in textbook; Section: [Dating Methods]{ .underline}
- [**Key Terms:**]{ .underline } Relative Dating, Strata, Stratigraphy, Stratum, Law of Superposition, Biostratigraphy,
Faunal Correlation, Index Fossils, Absolute/Radiometric/Chronometric Dating, Radioactive Decay, Elements, Isotopes, Half-Life, 
^14^C dating, K-Ar/Ar-Ar dating, Uranium-series dating, Dendrochronology, Carbon Calibration, Old Wood Problem
...
history of an organism throughout its individual lifetime. The word has also been co-opted in species discussions
...
how it is that we know when and under what conditions our species began to navigate the Earth. That's right, buckle your seatbelts, it is time to talk about Methods. 
Over the next couple of weeks we will thus be learning about how it is that we *know* what we *know*. Being that much of our understanding
...
contextual aspects of human paleontology and archaeology. Perhaps surprisingly, the methods that have become so important to us
...
two general approaches to this goal: **Relative Dating** and **Absolute (or Radiometric/Chronometric) Dating**. Before getting into the details of each
we can summarize them with a colloquial analogy. In this hypothetical, let's say that the last time you travelled out of state was in the month of May.
...
you travelled just before the Summer Break or you could provide the exact date (say, 05/20/2026). The first response is less exact but in placing it in relative position to 
...
::: {#fig-dating style="float: right; margin-left: 15px; max-width: 25%;"}
![](../images/time/dating.jpg){.lightbox}

Two approaches to dating archaeological and paleontological sites

:::

The image to the right highlights this. It shows successive layers of rock that we call **Strata**. On the right side of these rocks are 
...
It is known that our numerical dates are seldom 100% accurate. Instead they are more likely to provide a range of dates within a certain degree of confidence. 
Here the upper age is really suggesting that that stratum sits between approximately 115-125 Ma. More on that later. On the left of the rocks, under Relative Dating, there is simply
...
that one of these layers represents a specific event (say like the date that you traveled out of state or, more to the point, something like the extinction of dinosaurs). With that we could use the relative 
dating scheme to say that some strata are older than the extinction of dinosaurs and some are younger (like saying that you travelled before or after the Summer Break). We would thus indicate that
one of the strata illustrates a notable event (like mass extinction), and that the layer below this event occured earlier than it and the layers above occured after it. This is how Superposition works
and establishes the fundamental logic of Relative Dating.
...
before *Homo*. This is a relative dating timeline that can be redrawn in a couple of ways [@fig-hominin-evolution]. 

::: {#fig-hominin-evolution layout-rows="2"}
...
Both timelines illustrate the logic of relative dating. Though they do not give you numerical ages, such timelines do well to illustrate an order of events. In many discussions
...
fossils and (2) because they form in predictable chronological ways. As suggested by the name, these are formed by sediments of other materials. While
largely made up of other geologic material, they are also regularly comprised of other materials (organic or inorganic). The original sediments that form these rocks come from the
process of **erosion**. Be it wind, rain, sun, or simply time, all things erode into smaller pieces. When this happens, the sediments begin a new life detached 
from their parent structure. Depending on the size of the eroded particle, a variety of energetic forces will then act to move it from one spot to another. Energetic disparity across different regions 
therefore creates areas of high erosion and transport (high energy environments) and areas of **deposition** (lower energy environments where sediments are deposited). Depositional environments are where we see 
...
::: {.callout-tip}
## Sidenote on Sedimentation

Understanding the energy requirements for sediment transport is actually pretty cool. When looking at depositional environments you can begin to form an idea of the 
...
OK, now picture this depositional environment. It could be a sand dune or the bottom of a lake or ocean. In any case sediments are slowly accumulating and burying whatever lay there 
...
materials and the sediments begin to literally glue together. This is the process of Sedimentary Rock formation (@fig-sediment). Physical structures succomb to erosion,  eroded particles are carried away from from their parent structures until the transporting energy dissipates and they become sediments, 
...
glue together to form distinct layers of rock. These are strata and anything that gets cought in the process becomes trapped and (hopefully) preserved through time. The deepest strata, by 
necessity, formed before the strata above them. **BAM! Superposition**. Suffice it to say that this cycle starts all
over again when that stratum is eventually exposed again to the elements and begins to erode. 
...
mixes with sediments to make these darker hues. White horizons could signify an abundance of quartz or, when composed of Limestone, reflect ancient ocean floors (Limestone is comprised of marine shells).
...
Minerals such as hematite, chlorite, and goethite are illustrated in the colorful stratigraphuc bands](../images/time/Zhangye.jpg)
...
Volcanic Rhyolite (igneous material) that fell over the landscape and created horizons rich in deep purples.](../images/time/paintedhills.jpg)
...
::: {#fig-fossilization style="float: right; margin-left: 15px; max-width: 25%;"}
![](../images/time/fossilization.jpg){.lightbox}

The ideal process of fossilization. An animal dies in a depositional environment and slowly becomes buried in sediments. As the sedimentary process continues, the hard tissues (bones and teeth)
of this animal become preserved in rock. Eventually this rock becomes exposed and the fossils are uncovered by paleontologists (or archaeologists). 
...
the geological material that helps us to identify and define them. Even more useful to this cause are the fossils that get buried within these horizons in successive 
...
plants, animals, and even bacteria can become preserved in these strata (@fig-fossilization). Such environments create tombs which encase the most structurally sound components of 
...
riddle is to look at the fossils and to establish a stratigraphic pattern based on the organisms that lived in each period of time. 

::: {.callout-tip}
## Sidenote on Finding Fossils

Having not discussed it much, it may seem like the inclusion of fossils in strata is a rarity. Not really. There is [a lot]{.underline} of 
...
age of strata within a stratigraphic sequence (see @tbl-biostrat). The first of these goals, referred to more specifically as **Fuanal Correlation**, is discussed above. This process allows 
...
volcanic eruption, erosion of river valleys, and etcetera). The second approach to Biostratigraphy is the explicit use of fossils as time markers. Key to this effort is the 
identification of materials that we call Index Fossils. 
...
|                        | add ecological information by identifying fossil species present in one sample but not the other. This process can also inform on               |
|                        | processes such as plate tectonics and volcanic activity, and establish a relative timeline (series of events) across the fossil record.         |
+------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------+
...
::: {#fig-trilobite style="float: right; margin-left: 15px; max-width: 25%;"}
![](../images/time/trilobite.jpg){.lightbox}

Redlichiida trilobite indicative of an Early to Middle Cambrian age. 
:::
...
In meeting these criteria, the fossils not only have the power to identify specific strata from different regions (faunal correlation), but to delineate the specific period 
...
makes it easy to identify, it was short lived relative to other Orders of Trilobite (only existing for about 21 million years), and it was abundant and widespread during its existence. For a paleontologist, 
...
![Chronology of Trilobite Orders. Image from [trilobites.info](https://www.trilobites.info/geotime.htm)](../images/time/trilo.png){.lightbox width="70%"}
...
![Using Index Fossils. Notice that the red and blue strata illustrate different combinations of fossils through time. While most
of the fossils exist through the entire stratigraphic column, there are two which have narrow age ranges. These two fossils help to
differentiate the horizons and provide a successive view of life in this region over time.](../images/time/indexfossils.jpg){#fig-index .lightbox}
...
The image below helps exemplify this process. Consider for a moment that you are a researcher in Area A. This is the only site that does not have the needed material to obtain a
 ...
 fossils found in your site. Knowing this, and knowing that the other research areas have absolute dates associated with certain fossils, can you estimate
...
![Biostratigraphy and Absolute Dating. Use the overlapping strata across the four stratigraphic columns to identify the approximate age of the red spiral shells.](../images/time/biostrat.png){#fig-biostrat .lightbox width="65%"}

# Absolute (Radiometric) Dating

::: {style="float: right; margin-left: 15px; max-width: 30%;"}
![](../images/time/meltclock.jpg){.lightbox}

:::

Absolute dating is better referred to as Radiometric (or Chronometric) dating. This is because, despite refined methods, seldom are dates “absolute”. This was discussed briefly above 
(in reference to @fig-dating). These dates always come with a confidence interval (age range) dictated by a margin of error. Thus in 
...
::: {#fig-kar style="float: right; margin-left: 15px; max-width: 30%;"}
![](../images/time/k-Ar.png){.lightbox}

Two different ways that ^40^K decays into different byproducts. The right side of this image illustrates the decay of potassium into calcium. Here an 
electron is emitted, and a neutron picks up a positive charge, transitioning it to a proton. This is called *beta decay*. On the left side of the image, 
we see the parent atom decay into Argon. The process in this case is called *electron capture* in that a proton is converted to a neutron (giving us 18 
protons and [22]{.underline} neutrons in the daughter atom (typo in figure). 
...
making them radioactive. @fig-kar on the right depicts this process. Volcanic ash is largely comprised of radioactive potassium (^40^K). As the ash cools down, and 
the energy dissipates, these radioactive nuclides spontaneously breakdown (decay) into more stable forms (^40^Ar). The moment this process starts is the 
...
the eruption of the volcano. This is what we mean by “resetting” or “zeroing” the clock. 

#### Understanding Half-Life

::: {#fig-half style="float: left; margin-right: 15px; max-width: 25%;"}
![](../images/time/halflife.png){.lightbox}

The decay of Uranium into Throium through successive half-lifes.
...
In the previous example we would measure the abundance of ^40^K to ^40^Ar in volcanic rock (pumice). It is also important to understand that radioactive decay is spontaneous. 
As mentioned above, we can only measure the pace of decay through relative terms (not the time it takes for one atom to decay into another). 
This means that we are not counting how many atoms there are in a given sample. Instead, we investigate how much time it takes for approximately half of the parent product to decay into the daughter product. Thus, our unit of measure 
is not an actual count of atoms, it is instead the measure of a **half-life**. This is the amount of time it takes for a sample to lose half of its radioactive material through decay. 
@fig-half relates the decay of radioactive Uranium to Lead, stating that the half-life is 1 billion years. Thus it takes 1 billion years for half of the radioactive uranium to decay into 
...
another 40 years would mean another 5 fingers. This is not the case with radioactive decay. The decay rate of radioactive isotopes is one that is proportional 
...
Carbon Dating is a topic also covered pretty well by the textbook but it is an important method and worth reviewing here as well. So how does it all work? 
...
three common isotopes (12, 13 14). Carbon 14 (^14^C) is radioactive. It originates in the atmosphere as Nitrogen 14 (^14^N) that is irradiated by the sun’s 
cosmic waves. The high-energy neutrons of these cosmic rays collide with ^14^N atoms (Atomic Number=7, Mass Number=14). When these particles 
collide, the incoming neutrons knock out a proton and gain one neutron (shifts from 7-and-7 to 6-and-8). This accounts for the creation of ^14^C.

::: {#fig-car1 style="float: right; margin-left: 15px; max-width: 40%;"}
![](../images/time/carbon1.png){.lightbox}

The distribution of ^14^C through the atmosphere, biosphere, and hydrosphere. 
...
continue consuming it, the amount of ^14^C in our bodies will be the same as everything else consuming carbon (see @fig-car2 for stepwise process). 

::: {#fig-car2 style="float: left; margin-right: 15px; max-width: 25%;"}
![](../images/time/carbon2.png){.lightbox}

^14^C cycle from inception to decay.

:::

The radiometric clock for ^14^C decay begins with the death of an organism (when it stops consuming ^14^C). From here on out, the only ^14^C activity occurring in our 
...
upon its inception, unfortunately making it impossible for us to measure the proportion of the two isotopes. But since we know how much ^14^C is in the living organisms around us, 
we can see how much remains in the sample material relative to how much there would be in the “zeroed” clock (living organisms). From there the process is the same as most radiometric methods. 
We build our timeline from the knowledge of ^14^C having a [half-life of 5,730 years]{.underline}. 

### Limitations of Carbon Dating

The most notable limitation of Carbon Dating is the short half-life of ^14^C. Only dating materials as old as ~50-55 ka means that this method is inapplicable to 
many geochronological questions.
As long as we stick within the field of Archaeology, however, it is mostly a non-issue. More pressing issues with this method relate to the 
fluctuating concentrations of ^14^C in our atmosphere and to the potential to confuse the method's [precision]{.underline} with the [accuracy]{.underline} of its application. Both of these
issues need to be understood before having any confidence in published ^14^C dates.

#### Calibrating the Carbon Record

::: {#fig-dendro style="float: right; margin-left: 15px; max-width: 25%;"}
![](../images/time/dendro.jpg){.lightbox}

Cross-dating in dendrochronology

:::

Dendrochronology is the study of Tree-Ring Dating. In short, this method is grounded in the understanding that concentric rings are formed within a tree’s core 
throughout life and that the rings can be counted as successive years. Extensive records of tree-ring dates are strung together by overlapping multiple samples of 
trees of the same species and from the same regions. This system works because rings depicting the same patterns in different trees illustrate the same years of 
growth. The matching of patterns is possible because the rings vary in size and color depending on environmental conditions. Thus, the same environmental conditions 
in a ten-year span will create the same ring pattern on young trees and old trees of the same species in a particular area. The difference in age of these samples is 
important. If, say, the older tree was already 100 years old at this time, and then died shortly after, the rings for that ten-year span would be near the outer layer 
of the tree core (new rings form beneath the tree bark). Thus, the record is preserved at the end of a 100-year lifespan with the inner core representing the beginning 
of it. If we assume that the younger tree continued to grow for another 100 years after that, the same ten-year span would be found deep in the inner core of the tree. 
While each of these trees accounts for 100-year records of growth, overlapping the conforming ten-span provides dendrochronologists with a 200-year record. The current 
dendrochronological record stretches back more than 11,000 years (Friedrich et al., 2004; Leavitt and Bannister 2009). 

In accounting for the known fluctuations of radiocarbon in our atmosphere, dendrochronologists work with radiocarbon labs to calibrate ^14^C concentrations over the 
tree-ring record. Since carbon dating works on all organic material, ^14^C levels can be calculated for each ring (or at least averages for sets of rings) throughout 
this 11,000+ year timeline. It thus detects years where the concentrations are higher (which would mean higher baseline) or lower (lower baseline) (see @fig-calb). This allows researchers 
to adjust their findings to the accurate year. Say, for instance, a radiocarbon analysis came back with a 50% concentration. Your instinct would be to suggest that the 
sample is 5,730 years old (half-life of ^14^C). But then you match your findings with the tree-ring record and notice that that specific concentration matches with a 
ring that is 7,000 years old. You would then know that at this time 7,000 years ago, the ^14^C concentrations were higher than they are today. 

To use our example from earlier, years with higher concentrations of carbon would be like a person born with 12 fingers instead of 10. It would still take 
40 years to lose half of their fingers, but the measurement would be of 6 fingers not 5. If you read these results not knowing that the person began with 12 
fingers, you might be mislead into thinking that less time has passed than actual has (29.4 years instead of 40 years). 

::: {#fig-calb style="float: right; margin-left: 15px; max-width: 25%;"}
![](../images/time/calibration.jpg){.lightbox}

Calibrating the carbon record. Note the fluctuating concentrations of ^14^C in the tree-rings. Along with the cross-dating of dendrochronological samples, this provides a record of
^14^C concentrations through time. 

:::

In summary, we know that the half-life of ^14^C is 5,730 years but that the baseline atmospheric concentration of this isotope varies through time. 
To use the tree-ring record, archaeologists can circumvent the issue of fluctuating ^14^C levels by comparing the raw results of their analysis to the ^14^C 
levels in dated tree-rings. While this process does sidestep the calculation of the carbon age of materials, it is important to remember that 1) the tree ring 
record is only approximately 11-12 thousand years old, 2) not all materials used in ^14^C analysis are wood (bones, seeds, and etcetera), and 3) not all wood 
in archaeological contexts preserves the needed rings to match against the tree-ring record. Thus, beyond the evident applications of tree-ring calibration 
(in match specific dates), the method also informed geochronologists about the expected error in their analyses (being that carbon levels do in fact vary). 
This is why will see signifiers in academic literature as it reflects Calibrated or Uncalibrated dates.  
...
Even with the known fluctuation of ^14^C in our atmosphere, Carbon Dating is prettey dang precise. This, however, doesn't always mean it is accurate. When using the term
precision, we are simply stating that the method works. The analysis will provide you with an age for that sample that you can be confident in. But the age for that sample is 
not always the age for the use of that artifact. There are a couple of ways to consider the potential for [inaccurate]{.underline} age estimations from radiocarbon analysis.

First: Probably the most ubiquitous material used in carbon dating is charcoal. This burnt wood is commonly found preserved in cooking pits from habitation areas. While the charcoal
provides a great sample for carbon dating, the archaeologist must be aware that only a small section of that wood is there to sample. If the piece came from deep within the tree core,
it will reflect an old age but probably not the actual age of its use in the fire. This is known as the **old wood problem**. The age of that piece of charcoal is precise but it does not accurately
reflect when it was used by humans. This also means that it does not provide a reliable age estimation for the site. 

Second: Archaeologists often find good samples of wood for carbon dating in ancient construction materials (say like beams used for building construction). One potential pitfall in associating the
carbon date of this beam with the archaeological site is that you can't actually be sure if the tree was felled at the time of construction. The recycling of materials is not uncommon in the archaeological record.
That said, when populations reuse materials salvaged from earlier settlements, archaeologists are faced with potentially misleading temporal evidence. The wooden beam in this case would 
date to an earlier period of time than the construction of the particular site in question. 

Third: The final variation of this **old wood problem** concerns driftwood. Archaeologists here in Hawai'i know this issue well. Just as in the previous example, we have come to understand that 
finding wood in a site does not necessarily mean that the age of the site matches that of the wood. This is particularly the case when working in coastal environments where wood of various ages
can drift on shore and be used by the populations inhabiting the area. 

In all of the above cases we can see that, despite being precise, associating carbon dates with archaeological sites can still be inaccurate.