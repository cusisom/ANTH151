...
![](../images/dating-fossils.jpg){.lightbox width="50%"}
...
Minerals such as hematite, chlorite, and goethite are illustrated in the colorful stratigraphuc bands](../images/Zhangye.jpg)
...
Volcanic Rhyolite (igneous material) that fell over the landscape and created horizons rich in deep purples.](../images/paintedhills.jpg)
...
![Using Index Fossils](../images/indexfossils.jpg){#fig-index .lightbox}
...
![Biostratigraphy and Absolute Dating](../images/biostrat.png){#fig-biostrat .lightbox width="65%"}
...
::: {#fig-kar style="float: right; margin-left: 15px; max-width: 20%;"}
...
As long as we stick within the field of Archaeology, however, it is mostly a non-issue. More pressing issues relate to the 
fluctuating concentrations of ^14^C in our atmosphere and to the potential to confuse the method's [precision]{.underline} with the [accuracy]{.underline} of its application. 

#### Calibrating the Carbon Record

Dendrochronology is the study of Tree-Ring Dating. In short, this method is grounded in the understanding that concentric rings are formed throughout a tree’s core 
...
this 11,000+ year timeline. It thus detects years where the concentrations are higher (which would mean higher baseline) or lower (lower baseline). This allows researchers 
