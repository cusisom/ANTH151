...
to foster an understanding of human development and culture change through time from prehistory to the present (or near present) and across major regions of the globe. It is meant
...
<div style="margin-bottom: 20px;">
  <a class="btn btn-primary" href="files/Anth 151 online Exam format.pdf" download="Anth 151 online Exam format.pdf">
    <i class="bi bi-download"></i> Download Exam Guide
  </a>
</div>
...
<details>
  ...
  <iframe src="files/Anth 151 online Exam format.pdf" width="100%" height="800px" style="border: 1px solid #ccc;"></iframe>
</details>
...
I know that navigating two websites and a variety of textbooks and articles could get a little confusing. I will do my best to make things as straightforward as possible. To differentiate through
the two website options, I will be sure to specify whether I am refering to the **Lamaku Site** or the **Course Webpage**. As is mentioned below, any journal articles that we read will be viewable (and
downloadable) on the Lamaku Site and on our Course Webpage. 
...
- Assigned reading format:
	- textbook: ch.xx
	- Course Webpage: ch. xx

**Important**: The assigned reading listed on the syllabus is a short reference. It does not specify which sections from the text book you are assigned to read. For this information you can
either consult the corresponding week on this website or through the Lamaku site. Do not put yourself through the trouble of reading more than you have too. 

Each Figure, Table, and Video in these web chapters is expandable by clicking on it. Some will also have drop down captions like the image above. Be sure to read through that information 
too when a website chapter is assigned. 
